...
<html class="ie9" lang="en">
   ...
   <html lang="en">
      ...
      <head>
         ...
         <link rel="stylesheet" type="text/css" media="all" href="../css/style-forte-mx.css">
...
-->
            ...
            <div class="in-mbanner-back">
               <div class="in-mbanner">
                  <div class="">
                     <h1 class="in-mtitle"><?php echo $PXP_FORTE_MX_TITTLE_WORD; ?></h1>
                  </div>
               </div>
            </div>
            <!--content-->
            <div class="in-mcontainer">
               <div class="in-mcontainer-izq">
                  <div class="in-mcontainer-izq-text">
                     <h3><?php echo $PXP_FORTE_MX_SUBTITTLE_WORD; ?></h3>
                     <!--<h4>alfa PXP FORTE</h4>-->
                     <p><?php echo $PXP_FORTE_MX_DESCRIPTION; ?></p>
                  </div>
            ...
            <div class="in-scontainer">
               <div class="in-spoints-sm">
                  ...
                  <ul>
                     <li>
                        <p><?php echo $PXP_FORTE_MX_BENEF_ONE; ?></p>
                     </li>
                     <li>
                        <p><?php echo $PXP_FORTE_MX_BENEF_TWO; ?></p>
                     </li>
                     <li>
                        <p><?php echo $PXP_FORTE_MX_BENEF_THREE; ?></p>
                     </li>
                     <li>
                        <p><?php echo $PXP_FORTE_MX_BENEF_FOUR; ?></p>
                     </li>
                  </ul>
                  <p style="border: solid; color: #34383D; padding: 10px;"><?php echo $STR_FDA_STATEMENT; ?></p>
               </div>
               <div class="in-simage">
                  <img src="https://enzactamedia.enzacta.com/prod/images/alfa-pxp-forte-mx-boxes-260213.jpg" alt="alfa PXP FORTE - Boxes and Packet">
               </div>
               <div class="in-spoints">
                  ...
                  <p style="border: solid; color: #34383D; padding: 10px; margin-right: 15px;"><?php echo $STR_FDA_STATEMENT; ?></p>
               </div>
               <span class="cf"></span>
            </div>
