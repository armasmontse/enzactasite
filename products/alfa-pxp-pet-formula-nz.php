<?php
   ...
   include("../Customer/javascript_library.php");
...
<html class="ie9" lang="en">
   ...
   <html lang="en">
      <!--<![endif]-->
      <head>
         <title>alfa PXP PET FORMULA</title>
         <!--meta info-->
         <meta charset="utf-8">
         ...
         <link rel="stylesheet" type="text/css" media="all" href="../css/style-pet.css">
...
-->
                              ...
                              <nav role="navigation" class="d_inline_m d_xs_none m_xs_right_0 m_right_15 t_align_l m_xs_bottom_15">
                                 <ul class="hr_list main_menu fw_light">
                                    ...
                                    <li class="relative f_xs_none m_xs_bottom_5">
                                       ...
                                       <?php if ($data_country =="US"||$data_country =="MX"||$data_country =="NZ"||$data_country =="KR"||$data_country =="CA"||$data_country =="CO"||$data_country =="EC"||$data_country =="SV"||$data_country =="GT"||$data_country =="ES"||$data_country =="HK"||$data_country =="GB"||$data_country==""){ ?>
                                       <!--sub menu-->
                                       <ul class="sub_menu r_xs_corners bg_light vr_list tr_all tr_xs_none trf_xs_none bs_xs_none d_xs_none lin_hei_24">
                                          ...
                                          <?php 
                                             if ($data_country =="US"||$data_country =="MX"||$data_country =="NZ"||$data_country =="KR"||$data_country =="CO"||$data_country =="EC"||$data_country =="SV"||$data_country =="GT"||$data_country =="GB"||$data_country =="") { ?>
                                          <li class="relative">
            ...
            <div class="in-mbanner-back">
               <div class="in-mbanner">
                  <div class="">
                     <h1 class="in-mtitle"><?php echo $PXP_PET_TITTLE_WORD; ?></h1>
                  </div>
               </div>
            </div>
            <!--content-->
            <div class="in-mcontainer">
               <div class="in-mcontainer-izq">
                  <div class="in-mcontainer-izq-text">
                     <h3><?php echo $PXP_PET_SUBTITTLE_WORD; ?></h3>
                     <!--<h4>alfa PXP PET FORMULA</h4>-->
                     <p><?php echo $PXP_PET_DESCRIPTION; ?></p>
                  </div>
                  <div class="in-mcontainer-izq-img">
                     <img src="https://enzactamedia.enzacta.com/prod/images/brown-rice-alfa-pxp-pet-formula.jpg" alt="alfa PXP PET FORMULA - Brown rice grains">
                  </div>
               </div>
               <div class="in-mcontainer-der">
                  <img src="https://enzactamedia.enzacta.com/prod/images/powder-rice-spoon-alfa-pxp-pet-formula.jpg" alt="alfa PXP PET FORMULA - Rice powder wooden spoon.">
               </div>
               <span class="cf"></span>
            </div>
            <div class="in-scontainer">
               <div class="in-spoints-sm">
                  ...
                  <ul>
                     <li>
                        <p><?php echo $PXP_PET_BENEF_ONE; ?></p>
                     </li>
                     <li>
                        <p><?php echo $PXP_PET_BENEF_TWO; ?></p>
                     </li>
                     <li>
                        <p><?php echo $PXP_PET_BENEF_THREE; ?></p>
                     </li>
                  </ul>
                  <p style="border: solid; color: #34383D; padding: 10px;"><?php echo $STR_FDA_STATEMENT; ?></p>
               </div>
               <div class="in-simage">
                  <img src="https://enzactamedia.enzacta.com/prod/images/alfa-pxp-pet-formula-NZ.jpg" alt="alfa PXP PET FORMULA - Bag">
               </div>
