...
<html class="ie9" lang="en">
   ...
   <html lang="en">
      ...
      <head>
         ...
         <link rel="stylesheet" type="text/css" media="all" href="../css/style-plus.css">
...
-->
            ...
            <div class="in-mbanner-back">
               <div class="in-mbanner">
                  <div class="">
                     <h1 class="in-mtitle"><?php echo $PXP_PLUS_TITTLE_WORD; ?></h1>
                  </div>
               </div>
            </div>
            <!--content-->
            <div class="in-mcontainer">
               <div class="in-mcontainer-izq">
                  <div class="in-mcontainer-izq-text">
                     <h3><?php echo $PXP_PLUS_SUBTITTLE_WORD; ?></h3>
                     <!--<h4>alfa PXP PLUS</h4>-->
                     <p><?php echo $PXP_PLUS_DESCRIPTION; ?></p>
                  </div>
                  <div class="in-mcontainer-izq-img">
                     <img src="https://enzactamedia.enzacta.com/prod/images/ear-rice-alfa-pxp-plus.jpg" alt="Ear of brown rice">
                  </div>
               </div>
               <div class="in-mcontainer-der">
                  <img src="https://enzactamedia.enzacta.com/prod/images/brwon-rice-sack-alfa-pxp-plus.jpg" alt="alfa PXP PLUS - brown rice grains.">
               </div>
               <span class="cf"></span>
            </div>
            <div class="in-scontainer">
               <div class="in-spoints-sm">
                  ...
                  <ul>
                     <li>
                        <p><?php echo $PXP_PLUS_BENEF_ONE; ?></p>
                     </li>
                     <li>
                        <p><?php echo $PXP_PLUS_BENEF_TWO; ?></p>
                     </li>
                     <li>
                        <p><?php echo $PXP_PLUS_BENEF_THREE; ?></p>
                     </li>
                  </ul>
                  <p style="border: solid; color: #34383D; padding: 10px;"><?php echo $STR_FDA_STATEMENT; ?></p>
               </div>
               <div class="in-simage">
                  <img src="https://enzactamedia.enzacta.com/prod/images/alfa-pxp-plus-kr-box-ingredient.jpg" alt="alfa PXP PLUS - Bottle ingredients">
               </div>
