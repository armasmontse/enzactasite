...
-->
                              ...
                              <nav role="navigation" class="d_inline_m d_xs_none m_xs_right_0 m_right_15 t_align_l m_xs_bottom_15">
                                 <ul class="hr_list main_menu fw_light">
                                    ...
                                    <li class="relative f_xs_none m_xs_bottom_5">
                                       ...
                                       <?php if ($data_country =="US"||$data_country =="MX"||$data_country =="KR"||$data_country =="CA"||$data_country =="CO"||$data_country =="EC"||$data_country =="SV"||$data_country =="GT"||$data_country =="ES"||$data_country =="HK"||$data_country =="GB"||$data_country ==""){ ?>
                                       <!--sub menu-->
            ...
            <div class="in-scontainer">
               ...
               <div class="in-simage">
                  <img src="https://enzactamedia.enzacta.com/prod/images/alfa-pxp-pet-formula-bag-ingredient.jpg" alt="alfa PXP PET FORMULA - Bag">
               </div>
