...
<html class="ie9" lang="en">
   ...
   <html lang="en">
      ...
      <head>
         ...
         <link rel="stylesheet" type="text/css" media="all" href="../css/style-energy.css">
...
-->
            ...
            <div class="in-mbanner-back">
               <div class="in-mbanner">
                  <div class="">
                     <h1 class="in-mtitle"><?php echo $ENERGY_TITTLE_WORD; ?></h1>
                  </div>
               </div>
            </div>
            <!--content-->
            <div class="in-mcontainer">
               <div class="in-mcontainer-izq">
                  <div class="in-mcontainer-izq-text">
                     <h3><?php echo $ENERGY_SUBTITTLE_WORD; ?></h3>
                     <!--<h4>alfa ENERGY</h4>-->
                     <p><?php echo $ENERGY_DESCRIPTION; ?></p>
                  </div>
                  <div class="in-mcontainer-izq-img">
                     <img src="https://enzactamedia.enzacta.com/prod/images/water-molecules.jpg" alt="alfa ENERGY - Water oxygen molecules">
                  </div>
               </div>
               <div class="in-mcontainer-der">
                  <img src="https://enzactamedia.enzacta.com/prod/images/water-splash.jpg" alt="alfa ENERGY - Water splash">
               </div>
               <span class="cf"></span>
            </div>
            <div class="in-scontainer">
               <div class="in-spoints-sm">
                  ...
                  <ul>
                     <li>
                        <p><?php echo $ENERGY_BENEF_ONE; ?></p>
                     </li>
                     <li>
                        <p><?php echo $ENERGY_BENEF_TWO; ?></p>
                     </li>
                     <li>
                        <p><?php echo $ENERGY_BENEF_THREE; ?></p>
                     </li>
                  </ul>
                  <p style="border: solid; color: #34383D; padding: 10px;"><?php echo $STR_FDA_STATEMENT; ?></p>
               </div>
               <div class="in-simage">
                  <img src="https://enzactamedia.enzacta.com/prod/images/alfa-energy-bottle-ingredient.jpg" alt="alfa ENERGY -  Bottle ingredients">
               </div>
