...
<html class="ie9" lang="en">
   ...
   <html lang="en">
      ...
      <head>
         ...
         <link rel="stylesheet" type="text/css" media="all" href="../css/style-rxp.css">
...
-->
            ...
            <div class="in-mbanner-back">
               <div class="in-mbanner">
                  <div class="">
                     <h1 class="in-mtitle"><?php echo $RXP_TITTLE_WORD; ?></h1>
                  </div>
               </div>
            </div>
            <!--content-->
            <div class="in-mcontainer">
               <div class="in-mcontainer-izq">
                  <div class="in-mcontainer-izq-text">
                     <h3><?php echo $RXP_SUBTITTLE_WORD; ?></h3>
                     <!--<h4>alfa B-12</h4>-->
                     <p><?php echo $RXP_DESCRIPTION; ?></p>
                  </div>
                  <div class="in-mcontainer-izq-img">
                     <img src="https://enzactamedia.enzacta.com/prod/images/fruits-alfa-rxp3.jpg" alt="alfa RXP - fruits">
                  </div>
               </div>
               <div class="in-mcontainer-der">
                  <img src="https://enzactamedia.enzacta.com/prod/images/grapes-horn-rxp1.jpg" alt=" alfa RXP - grapes on a plate">
               </div>
               <span class="cf"></span>
            </div>
            <div class="in-scontainer">
               <div class="in-spoints-sm">
                  ...
                  <ul>
                     <li>
                        <p><?php echo $RXP_BENEF_ONE; ?></p>
                     </li>
                     <li>
                        <p><?php echo $RXP_BENEF_TWO; ?></p>
                     </li>
                     <li>
                        <p><?php echo $RXP_BENEF_THREE; ?></p>
                     </li>
                     <li>
                        <p><?php echo $RXP_BENEF_FOUR; ?></p>
                     </li>
                     <li>
                        <p><?php echo $RXP_BENEF_FIVE; ?></p>
                     </li>  
                </ul>
                <p style="border: solid; color: #34383D; padding: 10px;"><?php echo $STR_FDA_STATEMENT; ?></p>
               </div>
               <div class="in-simage">
                  <img src="https://enzactamedia.enzacta.com/prod/images/alfa-RXP-NEW.jpg" alt="alfa RXP – Box & Packet">
               </div>
