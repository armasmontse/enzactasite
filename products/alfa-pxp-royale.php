...
<html class="ie9" lang="en">
   ...
   <html lang="en">
      ...
      <head>
         ...
         <link rel="stylesheet" type="text/css" media="all" href="../css/style-royale.css">
...
-->
                              ...
                              <nav role="navigation" class="d_inline_m d_xs_none m_xs_right_0 m_right_15 t_align_l m_xs_bottom_15">
                                 <ul class="hr_list main_menu fw_light">
                                    ...
                                    <li class="relative f_xs_none m_xs_bottom_5">
                                       ...
                                       <?php if ($data_country =="US"||$data_country =="MX"||$data_country =="KR"||$data_country =="CA"||$data_country ==""||$data_country =="EC"||$data_country =="SV"||$data_country =="GT"||$data_country =="ES"||$data_country =="GB"||$data_country ==""){ ?>
                                       <!--sub menu-->
            ...
            <div class="in-mbanner-back">
               <div class="in-mbanner">
                  <div class="">
                     <h1 class="in-mtitle"><?php echo $PXP_ROYALE_TITTLE_WORD; ?></h1>
                  </div>
               </div>
            </div>
            <!--content-->
            <div class="in-mcontainer">
               <div class="in-mcontainer-izq">
                  <div class="in-mcontainer-izq-text">
                     <h3><?php echo $PXP_ROYALE_SUBTITTLE_WORD; ?></h3>
                     <!--<h4>alfa PXP ROYALE</h4>-->
                     <p><?php echo $PXP_ROYALE_DESCRIPTION; ?></p>
                  </div>
                  <div class="in-mcontainer-izq-img">
                     <img src="https://enzactamedia.enzacta.com/prod/images/ear-purple-rice.jpg" alt="alfa PXP ROYALE - the purple royalty rice.">
                  </div>
               </div>
               <div class="in-mcontainer-der">
                  <img src="https://enzactamedia.enzacta.com/prod/images/spoon-pxp-royale.jpg" alt="alfa PXP ROYALE - spoon">
               </div>
               <span class="cf"></span>
            </div>
            <div class="in-scontainer">
               <div class="in-spoints-sm">
                  ...
                  <ul>
                     <li>
                        <p><?php echo $PXP_ROYALE_BENEF_ONE; ?></p>
                     </li>
                     <li>
                        <p><?php echo $PXP_ROYALE_BENEF_TWO; ?></p>
                     </li>
                     <li>
                        <p><?php echo $PXP_ROYALE_BENEF_THREE; ?></p>
                     </li>
                  </ul>
                  <p style="border: solid; color: #34383D; padding: 10px;"><?php echo $STR_FDA_STATEMENT; ?></p>
               </div>
               <div class="in-simage">
                  <img src="https://enzactamedia.enzacta.com/prod/images/alfa-pxp-royale-bottle-ingredient.jpg" alt="alfa PXP ROYALE - Bottle ingredients">
               </div>
            ...
            <div class="in-bottom-product">
               <div class="t_align_c avai_prod">
                  <p><?php echo $PXP_ROYALE_AVAIBLE; ?></p>
               </div>
            </div>
