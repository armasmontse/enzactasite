...
<html class="ie9" lang="en">
   ...
   <html lang="en">
      ...
      <head>
         ...
         <link rel="stylesheet" type="text/css" media="all" href="../css/style-extreme.css">
...
-->
            ...
            <div class="in-mbanner-back">
               <div class="in-mbanner">
                  <div class="">
                     <h1 class="in-mtitle"><?php echo $PXP_EXTREME_TITTLE_WORD; ?></h1>
                  </div>
               </div>
            </div>
            <!--content-->
            <div class="in-mcontainer">
               <div class="in-mcontainer-izq">
                  <div class="in-mcontainer-izq-text">
                     <h3><?php echo $PXP_EXTREME_SUBTITTLE_WORD; ?></h3>
                     <!--<h4>alfa B-12</h4>-->
                     <p><?php echo $PXP_EXTREME_DESCRIPTION; ?></p>
                  </div>
                  <div class="in-mcontainer-izq-img">
                     <img src="https://enzactamedia.enzacta.com/prod/images/lines-pxp-extreme.jpg" alt="alfa PXP EXTREME - lines">
                  </div>
               </div>
               <div class="in-mcontainer-der">
                  <img src="https://enzactamedia.enzacta.com/prod/images/beetroot-pxp-extreme.jpg" alt="alfa PXP EXTREME - beetroot">
               </div>
               <span class="cf"></span>
            </div>
            <div class="in-scontainer">
               <div class="in-spoints-sm">
                  ...
                  <ul>
                     <li>
                        <p><?php echo $PXP_EXTREME_BENEF_ONE; ?></p>
                     </li>
                     <li>
                        <p><?php echo $PXP_EXTREME_BENEF_TWO; ?></p>
                     </li>
                     <li>
                        <p><?php echo $PXP_EXTREME_BENEF_THREE; ?></p>
                     </li>
                  </ul>
                  <p style="border: solid; color: #34383D; padding: 10px;"><?php echo $STR_FDA_STATEMENT; ?></p>
               </div>
               <div class="in-simage">
                  <img src="https://enzactamedia.enzacta.com/prod/images/alfa-pxp-extreme-box-stickpack.jpg" alt="alfa PXP EXTREME – Box and Stickpack">
               </div>
            ...
            <div class="in-bottom-product">
               <div class="t_align_c avai_prod">
                  <p><?php echo $PXP_EXTREME_AVAIBLE; ?></p>
               </div>
            </div>
