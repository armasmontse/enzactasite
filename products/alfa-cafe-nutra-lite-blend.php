...
<html class="ie9" lang="en">
   ...
   <html lang="en">
      <!--<![endif]-->
      <head>
         <title>alfa CAFE NUTRA Lite Blend</title>
         <!--meta info-->
         <meta charset="utf-8">
         ...
         <link rel="stylesheet" type="text/css" media="all" href="../css/style-cafe-nutra-lite.css">
...
-->
            ...
            <div class="in-mbanner-back">
               <div class="in-mbanner">
                  <div class="">
                     <h1 class="in-mtitle"><?php echo $CAFE_LITE_TITTLE_WORD; ?></h1>
                  </div>
               </div>
            </div>
            <!--content-->
            <div class="in-mcontainer">
               <div class="in-mcontainer-izq">
                  <div class="in-mcontainer-izq-text">
                     <h3><?php echo $CAFE_LITE_SUBTITTLE_WORD; ?></h3>
                     <!--<h4>alfa CAFE NUTRA Lite Blend</h4>-->
                     <p><?php echo $CAFE_LITE_DESCRIPTION; ?></p>
                  </div>
                  <div class="in-mcontainer-izq-img">
                     <img src="https://enzactamedia.enzacta.com/prod/images/coffee-beens-splash.jpg" alt="alfa CAFE NUTRA Lite Blend - Coffee beens">
                  </div>
               </div>
               <div class="in-mcontainer-der">
                  <img src="https://enzactamedia.enzacta.com/prod/images/spoon-coffee.jpg" alt="alfa CAFE NUTRA Lite Blend - Spoon with coffee">
               </div>
               <span class="cf"></span>
            </div>
            <div class="in-scontainer">
               <div class="in-spoints-sm">
                  ...
                  <ul>
                     <li>
                        <p><?php echo $CAFE_LITE_BENEF_ONE; ?></p>
                     </li>
                     <li>
                        <p><?php echo $CAFE_LITE_BENEF_TWO; ?></p>
                     </li>
                     <li>
                        <p><?php echo $CAFE_LITE_BENEF_THREE; ?></p>
                     </li>
                  </ul>
                  <p style="border: solid; color: #34383D; padding: 10px;"><?php echo $STR_FDA_STATEMENT; ?></p>
               </div>
               <div class="in-simage">
                  <img src="https://enzactamedia.enzacta.com/prod/images/alfa-CAFE-NUTRA-Lite-Blend-box-ingredient.jpg" alt="alfa CAFE NUTRA Lite Blend - Box ingredients">
               </div>
            ...
            <div class="in-bottom-product">
               <div class="t_align_c avai_prod">
                  <p><?php echo $CAFE_LITE_AVAIBLE; ?></p>
               </div>
            </div>
